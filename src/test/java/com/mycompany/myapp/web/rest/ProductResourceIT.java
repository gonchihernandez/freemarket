...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).price(DEFAULT_PRICE).amount(DEFAULT_AMOUNT);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).price(UPDATED_PRICE).amount(UPDATED_AMOUNT);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).amount(UPDATED_AMOUNT);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).amount(UPDATED_AMOUNT);
