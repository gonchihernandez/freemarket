...
class PersonResourceIT {
    ...
    private static final Integer DEFAULT_CREDIT = 0;
    private static final Integer UPDATED_CREDIT = 1;
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).credit(DEFAULT_CREDIT);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).credit(UPDATED_CREDIT);
        return person;
    }
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getCredit()).isEqualTo(DEFAULT_CREDIT);
    }
    ...
    void putExistingPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).credit(UPDATED_CREDIT);
        ...
        assertThat(testPerson.getCredit()).isEqualTo(UPDATED_CREDIT);
    }
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).credit(UPDATED_CREDIT);
