  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="freemarketApp.marketplace.home.createOrEditLabel" data-cy="MarketplaceCreateUpdateHeading">
            Create or edit a Marketplace
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="marketplace-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="marketplace-name"
                name="name"
